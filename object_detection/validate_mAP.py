...
for min_score in range(60,100,5):
  ...
  min_score_threshold = min_score/100;
  FP_names = []
  FN_names = []
  ...
  for image_path in TEST_IMAGE_PATHS:
    ...
    for i in range(len(output_dict['detection_classes'])):
      if output_dict['detection_scores'][i] > min_score_threshold:
  ...
  value = "---- THRESHOLD: " + str(min_score) + " ----\n\n"
  log_txt.write(value)
  
  print("True Positives: " + str(TP))
  value = "True Positive: " + str(TP) + "\n"
  log_txt.write(value)
  
  print("False Positives: " + str(FP))
  value = "False Positives: " + str(FP) + "\n"
  log_txt.write(value)
  '''
  #print(FP_names)
  value = "FP Filenames: " + FP_names
  log_txt.write(value)
  '''
  print("False Negatives: " + str(FN))
  value = "False Negatives: " + str(FN) + "\n"
  log_txt.write(value)
  '''
  #print(FN_names)
  value = "FN Filenames: " + FN_names
  log_txt.write(value)
  '''
  log_txt.close()
  
  #Calc of Precision TP / (TP + FP)
  Precision = [0] * len(TP)
  for i in range(len(Precision)):
    if (TP[i] + FP[i]) > 0:
      Precision[i] = TP[i] / (TP[i] + FP[i])
  
  #Calc of Recall TP / (TP + FN)
  Recall = [0] * len(TP)
  ...
  value = "Min Score: " + str(min_score) + "\n"
  log_txt.write(value)
  
  print("Precision: " + str(Precision))
  value = "Precision: " + str(Precision) + "\n"
  log_txt.write(value)
  
  print("Recall: " + str(Recall) + "\n")
  value = "Recall: " + str(Recall) + "\n\n\n"
  log_txt.write(value)
  log_txt.close()
...
log_txt = open(log_file, 'a')
print("\nPrecision List: " + str(Precision_list))
value = "\nPrecision List: " + str(Precision_list) + "\n\n"
log_txt.write(value)

print("Recall List: " + str(Recall_list))
value = "Recall List: " + str(Recall_list)
log_txt.write(value)
log_txt.close()
